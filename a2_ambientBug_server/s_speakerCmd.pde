void speakerCmd(WebServer &server, WebServer::ConnectionType type, char *url_tail, bool tail_complete)
{
  URLPARAM_RESULT rc;
  char name[NAMELEN];
  int  name_len;
  ...
  if (strlen(url_tail))
    ...
    while (strlen(url_tail))
      ...
      sendToXBee(myParameters[0], SPEAKER_PATTERN, myParameters[1]);
    }
